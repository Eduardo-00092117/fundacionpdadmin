    ...
    <div class="row Acontenedor">
        <div class="col-md Asegmento">
            <div>
                <div class="row">
                    <div class="col">
                        <img src="{{$subarea[13]->url_imagen}}" alt="" width="100%">
                    </div>
                </div>
                <div class="row">
        ...
        <div class="col-md Asegmento">
            <div>
                <div class="row">
                    <div class="col">
                        <img src="{{$subarea[14]->url_imagen}}" alt="" width="100%">
                    </div>
                </div>
                <div class="row">
    ...
    <div class="row Acontenedor">
        <div class="col-md Asegmento">
            <div>
                <div class="row">
                    <div class="col">
                        <img src="{{$subarea[15]->url_imagen}}" alt="" width="100%">
                    </div>
                </div>
                <div class="row">
        ...
        <div class="col-md Asegmento">
            <div>
                <div class="row">
                    <div class="col">
                        <img src="{{$subarea[16]->url_imagen}}" alt="" width="100%">
                    </div>
                </div>
                <div class="row">
